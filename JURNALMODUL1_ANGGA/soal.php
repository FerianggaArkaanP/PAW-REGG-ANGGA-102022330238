...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (!ctype_alpha(str_replace(' ', '',($_POST["nama"])))) {
        $namaErr = "Nama hanya bisa diisi dengan huruf";
    }
    ...
    } elseif (!ctype_alpha(str_replace(' ', '',($_POST["jurusan"])))) {
        $jurusanErr = "Jurusan hanya bisa diisi dengan huruf";
    }
    ...
    } elseif (!ctype_alpha(str_replace(' ', '',($_POST["fakultas"])))) {
        $fakultasErr = "Fakultas hanya bisa diisi dengan huruf";
    }
}
?>
